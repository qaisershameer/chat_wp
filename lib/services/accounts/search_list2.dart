...
class _ApExampleState extends State<ApExample> {
  ...
  final List<Map<String, dynamic>> _allCoffeeData = [
    {
      'name': 'Espresso',
      'description': 'Strong Espresso Coffee with enriched flavour',
      'id': 'BAR-001',
    },
    {
      'name': 'Cappuccino',
      'description': 'Strong Cappuccino Coffee with enriched flavour',
      'id': 'BAR-002',
    },
    {
      'name': 'Late Cold Coffee',
      'description': 'Strong Late Read Journal Coffee with enriched flavour',
      'id': 'BAR-003',
    },
    {
      'name': 'Black Coffee',
      'description': 'Strong Black Silver Coffee with enriched flavour',
      'id': 'BAR-004',
    },
    {
      'name': 'Strong Coffe',
      'description': 'Strong Strong Cold Coffee with enriched flavour',
      'id': 'BAR-005',
    },
  ];
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: TypeAheadField(
          ...
          controller: _selectedItem,
          suggestionsCallback: (value){
            return _foundData.where((element) {
